...
package com.oxygen8.net.materialmenu;
...
import static com.oxygen8.net.materialmenu.MaterialMenuDrawable.DEFAULT_COLOR;
import static com.oxygen8.net.materialmenu.MaterialMenuDrawable.DEFAULT_PRESSED_DURATION;
import static com.oxygen8.net.materialmenu.MaterialMenuDrawable.DEFAULT_SCALE;
import static com.oxygen8.net.materialmenu.MaterialMenuDrawable.DEFAULT_TRANSFORM_DURATION;
import static com.oxygen8.net.materialmenu.MaterialMenuDrawable.IconState;
import static com.oxygen8.net.materialmenu.MaterialMenuDrawable.Stroke;
...
public class MaterialMenuView extends View implements MaterialMenu {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        TypedArray attr = getTypedArray(context, attributeSet, com.oxygen8.net.R.styleable.MaterialMenuView);
